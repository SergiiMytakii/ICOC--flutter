...
///[Create a constructor by passing user
...
class InstaPublicApi {
  ...
  Future<List<Post>> getAllPosts() async {
    ...
    if (totalPosts > postsLimit)
      log.e(
        'Total Posts are more than the specified limit, this might result in a huge time to load posts and might surpass Instagram\'s no. of requests/hour limit',
      );

    while (hasNextPage) {
      if (counter > postsLimit) {
        log.e(
          'loaded $counter posts!',
        );
        break;
      }
