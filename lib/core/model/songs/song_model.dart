...
class SongModel {
  ...
  factory SongModel.fromJson(Map parsedJson, int id) {
...
//todo replace in db all keys in shords to 'ru1', 'uk1' and so on Than uncomment line above to filter chords as well.  And than filter resourses as well
  ...
  SongModel filterAndOrderLanguages(List<String> orderLanguages) {
  ...
  SongModel orderByLanguage(List<String> orderLanguages) {
    return SongModel(
      id: id,
  ...
  static SongModel defaultSong() {
    return SongModel(id: 0, title: {'ru': 'default'}, text: {'ru1': 'default'});
  }
}
