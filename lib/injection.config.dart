...
import 'package:icoc/data/repository_impl/notifications_repository_impl.dart'
    as _i21;
import 'package:icoc/data/repository_impl/q&a_repository_impl.dart' as _i13;
import 'package:icoc/data/repository_impl/songs_repository_impl.dart' as _i17;
...
import 'package:icoc/domain/repository/bible_study_repository.dart' as _i18;
...
import 'package:icoc/domain/repository/q&a_repository.dart' as _i12;
import 'package:icoc/domain/repository/songs_repository.dart' as _i16;
...
import 'package:icoc/presentation/bloc/notifications_bloc/notifications_bloc.dart'
    as _i27;
import 'package:icoc/presentation/bloc/q&a_bloc/q&a_bloc.dart' as _i29;
import 'package:icoc/presentation/bloc/songs_bloc/songs_bloc.dart' as _i31;
import 'package:icoc/presentation/bloc/video_bloc/video_bloc.dart' as _i33;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i12.QandARepository>(
      () => _i13.QandARepositoryImpl(gh<_i6.LocalQandAdB>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.factory<_i16.SongsRepository>(
      () => _i17.SongsRepositoryImpl(
    ...
    gh.factory<_i18.BibleStudyRepository>(
      () => _i19.BibleStudyRepositoryImpl(
          firebaseDataSource: gh<_i14.FirebaseDataSource>()),
      registerFor: {
        _dev,
        _prod,
    ...
    gh.factory<_i20.NotificationsRepository>(
      () => _i21.NotificationsRepositoryImpl(gh<_i14.FirebaseDataSource>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.factory<_i22.FeedbackRepository>(
      () => _i23.FeedbackRepositoryImpl(gh<_i14.FirebaseDataSource>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.singleton<_i26.BibleStudyUserLanguagesHandler>(
      () => _i26.BibleStudyUserLanguagesHandler(gh<_i8.LocalCache>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.singleton<_i26.VideosUserLanguagesHandler>(
      () => _i26.VideosUserLanguagesHandler(gh<_i8.LocalCache>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.singleton<_i26.SongsUserLanguagesHandler>(
      () => _i26.SongsUserLanguagesHandler(gh<_i8.LocalCache>()),
      registerFor: {
        _dev,
        _prod,
      },
    ...
    gh.singleton<_i28.FavoriteSongStatusBloc>(
        () => _i28.FavoriteSongStatusBloc(gh<_i16.SongsRepository>()));
    gh.singleton<_i29.QandABloc>(
        () => _i29.QandABloc(gh<_i12.QandARepository>()));
    gh.singleton<_i30.FavoriteSongsListBloc>(() => _i30.FavoriteSongsListBloc(
          gh<_i16.SongsRepository>(),
          gh<_i26.SongsUserLanguagesHandler>(),
        ));
    gh.singleton<_i31.SongsBloc>(() => _i31.SongsBloc(
          gh<_i16.SongsRepository>(),
          gh<_i26.SongsUserLanguagesHandler>(),
        ));
    gh.singleton<_i32.FeedbackBloc>(
        () => _i32.FeedbackBloc(gh<_i22.FeedbackRepository>()));
    gh.singleton<_i33.VideoBloc>(() => _i33.VideoBloc(
          gh<_i24.VideoRepository>(),
          gh<_i26.VideosUserLanguagesHandler>(),
        ));
    gh.singleton<_i34.BibleStudyBloc>(() => _i34.BibleStudyBloc(
          gh<_i18.BibleStudyRepository>(),
