...
/* get songDetail from database*/
  ...
  Future<SongDetail> getSongDetail(int id, List<String> languagesToShow) async {
    final Database? database = await db;
    //filter which lang-s will be displaying
    _filterLangDisplaying(languagesToShow);
...
/* functions for full text search */
  ...
  Future<List<SongDetail>> getSearchResultByNumber(String searchQuery) async {
    final Database? database = await db;
