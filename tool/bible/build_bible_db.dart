...
class _BuildArgs {
  final String ukSource;
  final String ruSource;
  final String outPath;
  final String aliasesPath;
  final String? metaPath;

  const _BuildArgs({
    required this.ukSource,
    required this.ruSource,
...
Future<void> main(List<String> args) async {
  ...
  final (_TranslationRow ukTranslation, List<_VerseRow> ukVerses) =
      await _parseTranslation(config.ukSource, translationCode: 'uk');
  final (_TranslationRow ruTranslation, List<_VerseRow> ruVerses) =
      await _parseTranslation(config.ruSource, translationCode: 'ru');

  translations.add(ukTranslation);
  translations.add(ruTranslation);
  verses.addAll(ukVerses);
  verses.addAll(ruVerses);
  ...
  if (config.metaPath != null && config.metaPath!.isNotEmpty) {
    ...
    final Map<String, Object> metadata = <String, Object>{
      ...
      'sources': <Map<String, String>>[
        <String, String>{'code': 'uk', 'source': config.ukSource},
        <String, String>{'code': 'ru', 'source': config.ruSource},
      ],
